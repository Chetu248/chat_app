...
const LoginPage = () => {
  ...
  const [errorMsg, setErrorMsg] = useState(""); // 🔹 added for error handling
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      setErrorMsg(error.response?.data?.message || "Something went wrong. Please try again."); // 🔹 show error instead of white screen
    }
  };
